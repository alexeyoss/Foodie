...
class DishesAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DishesAdapter.DishHolder {
    ...
    override fun onBindViewHolder(holder: DishesAdapter.DishHolder, position: Int) {
