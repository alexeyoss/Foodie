...
import ru.alexeyoss.features.mainscreen.permission.DefaultPermissionRationalFragment
...
object Screens {
    ...
    fun permissionExplanationDialog(customPermissionsRationalStr: String) = FragmentScreen {
        ru.alexeyoss.features.mainscreen.permission.DefaultPermissionRationalFragment.getNewInstance(customPermissionsRationalStr)
    }
}