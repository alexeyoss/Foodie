package ru.alexeyoss.features.mainscreen
...
import ru.alexeyoss.features.mainscreen.di.MainActivityComponent
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        MainActivityComponent.Initializer
            .init(applicationContext as MainActivityDepsProvider)
